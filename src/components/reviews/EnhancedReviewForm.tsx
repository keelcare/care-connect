...
const RATING_CATEGORIES: RatingCategory[] = [
    ...
    { key: 'rating_punctuality', label: 'Punctuality', description: 'Arrived on time' },
    { key: 'rating_professionalism', label: 'Professionalism', description: 'Professional behavior' },
    { key: 'rating_care_quality', label: 'Care Quality', description: 'Quality of care provided' },
    { key: 'rating_communication', label: 'Communication', description: 'Clear communication' },
];
    ...
    return (
        <div className="bg-white rounded-2xl border border-stone-200 p-6 shadow-lg">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h3 className="text-xl font-semibold text-stone-900">Write a Review</h3>
                    <p className="text-stone-500 text-sm">Share your experience with {revieweeName}</p>
                </div>
                {onCancel && (
                    <button
                        onClick={onCancel}
