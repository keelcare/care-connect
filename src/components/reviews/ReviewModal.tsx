...
export const ReviewModal: React.FC<ReviewModalProps> = ({
    ...
    const checkEligibility = async () => {
        try {
            ...
            if (response.canReview) {
                ...
                setCanReview(false);
                setEligibilityError(response.reason || 'You cannot review this booking.');
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            addToast({ type: 'error', message: error instanceof Error ? error.message : 'Failed to submit review' });
        } finally {
            setLoading(false);
        }
    };
