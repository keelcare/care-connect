                ...
                <div className="h-full w-full bg-white shadow-xl flex flex-col animate-in slide-in-from-right duration-300">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-8">
                        ...
                        <div className="bg-amber-50 rounded-2xl p-6 border border-amber-100">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="space-y-1">
                                    <h3 className="font-semibold text-amber-900">Why was I suspended?</h3>
                                    <p className="text-sm text-amber-800/80 leading-relaxed">
                                        Accounts are usually suspended for violations of our Community Guidelines or Terms of Service. Common reasons include safety concerns, repeated cancellations, or verification issues.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="font-semibold text-neutral-900 group-hover:text-emerald-700">Contact Support</div>
                                        <div className="text-sm text-neutral-500">Email our safety team directly</div>
                                    </div>
                                    <ExternalLink size={16} className="text-neutral-300 group-hover:text-emerald-400" />
                                </div>
                            </a>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="font-semibold text-neutral-900 group-hover:text-emerald-700">Community Guidelines</div>
                                        <div className="text-sm text-neutral-500">Review our policies</div>
                                    </div>
                                    <ExternalLink size={16} className="text-neutral-300 group-hover:text-emerald-400" />
                                </div>
                            </a>
                        ...
                        <div className="pt-6 border-t border-neutral-100">
                            <h3 className="font-semibold text-neutral-900 mb-2">Think this is a mistake?</h3>
                            <p className="text-sm text-neutral-500 mb-4">
                                If you believe your account was suspended in error, you can submit an appeal request. Our team usually reviews appeals within 24-48 hours.
                            </p>
