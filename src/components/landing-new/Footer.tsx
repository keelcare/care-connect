      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-8">
              ...
              <span className="text-2xl font-bold text-[#0F172A]">Keel</span>
            </div>
            ...
            <div className="flex gap-4">
              {[Instagram, Twitter, Facebook, Linkedin].map((Icon, idx) => (
                <a key={idx} href="#" className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100 hover:text-[#E08E79] transition-colors">
                  <Icon size={20} />
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500 font-medium">
              <li><a href="#" className="hover:text-[#0F172A]">Child Care</a></li>
              <li><a href="#" className="hover:text-[#0F172A]">Senior Care</a></li>
              <li><a href="#" className="hover:text-[#0F172A]">Pet Care</a></li>
              <li><a href="#" className="hover:text-[#0F172A]">Housekeeping</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500 font-medium">
              ...
              <li><a href="#" className="hover:text-[#0F172A]">Trust & Safety</a></li>
              <li><a href="#" className="hover:text-[#0F172A]">Careers</a></li>
              <li><a href="#" className="hover:text-[#0F172A]">Press</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500 font-medium">
              ...
              <li><a href="#" className="hover:text-[#0F172A]">Contact Support</a></li>
              <li><a href="#" className="hover:text-[#0F172A]">Safety Center</a></li>
              <li><a href="#" className="hover:text-[#0F172A]">Resource Blog</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-sm font-medium text-gray-400">
            ...
            <a href="#" className="hover:text-[#0F172A]">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
