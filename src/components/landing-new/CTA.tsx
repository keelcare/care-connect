    ...
    <section className="h-dvh flex items-center justify-center px-6">
      <div className="max-w-7xl mx-auto">
        <div className="bg-primary-900 rounded-[60px] p-12 lg:p-24 relative overflow-hidden text-center">
          ...
          <div className="absolute top-0 right-0 w-96 h-96 bg-terracotta rounded-full mix-blend-multiply filter blur-3xl opacity-20 -translate-y-1/2 translate-x-1/4" />
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/book-service">
                <button className="w-full sm:w-auto bg-terracotta text-white px-12 py-5 rounded-full font-bold text-lg hover:scale-105 transition-transform">
                  Find Care Today
                </button>
              </Link>
