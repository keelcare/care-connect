...
export function Chatbot() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { id: 'welcome', role: 'assistant', content: 'Hi! I am your CareConnect assistant. How can I help you today?' }
    ]);
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none">
            ...
            <Button
                ...
                className={cn(
                    ...
                    isOpen ? "bg-neutral-800 hover:bg-neutral-900 rotate-90" : "bg-emerald-600 hover:bg-emerald-700"
                )}
            >
