...
export default function ShadowTeacherModal({ onClose, embedded = false }: ShadowTeacherModalProps) {
    const content = <BookingConfigurator serviceType="SHADOW_TEACHER" onClose={onClose} />;
