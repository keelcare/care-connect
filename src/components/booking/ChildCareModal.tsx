...
export default function ChildCareModal({ onClose, embedded = false }: ChildCareModalProps) {
    const content = <BookingConfigurator serviceType="CHILD_CARE" onClose={onClose} />;
