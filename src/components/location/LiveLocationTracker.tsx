...
export function LiveLocationTracker({
    ...
    const distanceToDestination = location && destinationLat && destinationLng
        ? calculateDistance(location.lat, location.lng, destinationLat, destinationLng)
        : null;
        ...
        <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                            ...
                            <Navigation size={20} className={isConnected ? 'text-emerald-600' : 'text-stone-400'} />
                        </div>
                        <div>
            ...
            {geofenceAlert && (
                <div className="px-5 py-3 bg-amber-50 border-b border-amber-100 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm font-medium text-amber-800">{geofenceAlert.message}</p>
                        <p className="text-xs text-amber-600">
                            Distance: {geofenceAlert.distance.toFixed(2)}km (Allowed: {geofenceAlert.radius}km)
                        </p>
                    </div>
                </div>
            )}
                ...
                {error ? (
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                            <AlertTriangle size={32} className="text-stone-400 mx-auto mb-2" />
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                            <Loader2 size={32} className="text-stone-400 mx-auto mb-2 animate-spin" />
