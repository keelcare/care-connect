        ...
        <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
            ...
            <div className="px-5 py-4 bg-gradient-to-r from-stone-50 to-emerald-50 border-b border-stone-100">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-stone-500">Configure location monitoring alerts</p>
                    </div>
                </div>
            </div>
            ...
            <div className="p-5 border-b border-stone-100">
                ...
                <p className="text-xs text-stone-500 mb-4">
                    You'll be notified if the caregiver moves beyond this distance from the designated location.
                </p>
                    ...
                    {PRESET_RADII.map((preset) => (
                        ...
                        >
                            <div className={`text-lg font-bold ${
                                settings.radius === preset.value ? 'text-emerald-700' : 'text-stone-900'
                            }`}>
                                {preset.label}
                            </div>
                            <div className={`text-xs ${
                                settings.radius === preset.value ? 'text-emerald-600' : 'text-stone-500'
                            }`}>
                                {preset.description}
                            </div>
                        </button>
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-stone-50 rounded-xl">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-medium text-stone-900">Enable Geofence Alerts</p>
                            <p className="text-xs text-stone-500">Receive real-time location alerts</p>
                        </div>
                    </div>
                    <button
                        ...
                        <div className="flex items-center justify-between p-4 bg-stone-50 rounded-xl ml-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-stone-500">Notify when leaving the area</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between p-4 bg-stone-50 rounded-xl ml-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-stone-500">Notify when returning to area</p>
                                </div>
                            </div>
                            <button
