    ...
    return (
        <div className="bg-white rounded-[28px] p-6 shadow-sm border border-gray-100 flex flex-col">
            <div className="flex items-center justify-between mb-5">
                ...
                <Link href="/dashboard/reviews" className="text-xs font-bold text-blue-600 hover:text-blue-700">View All</Link>
            </div>
                ...
                {displayReviews.map((review: any) => (
                    <div key={review.id} className="mb-5">
                        ...
                        <div className="flex items-center gap-2">
                             <div className="w-7 h-7 rounded-full bg-orange-400 flex items-center justify-center text-white font-bold text-[10px]">
