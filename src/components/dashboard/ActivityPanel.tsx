...
export function ActivityPanel({ activities = [] }: ActivityPanelProps) {
    ...
    return (
        <div className="bg-gradient-to-br from-dashboard-accent-start to-dashboard-accent-end rounded-[32px] p-8 text-white shadow-xl relative overflow-hidden h-full flex flex-col">
            {/* Decorative circles */}
            ...
            <Link href="/dashboard/notifications" className="block mt-auto">
                <Button
                    variant="ghost"
