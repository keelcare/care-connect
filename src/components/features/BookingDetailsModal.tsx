      ...
      <div className="bg-white rounded-[32px] w-full max-w-lg p-8 relative shadow-strong animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-2xl border border-neutral-100">
            ...
            <span
              className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${getStatusColor(booking.status)}`}
            >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-500">
                  ...
                  {booking.end_time ? formatTime(booking.end_time) : 'TBD'}
                </p>
              </div>
            </div>
