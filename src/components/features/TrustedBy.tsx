  ...
  const testimonials = [
    {
      ...
      quote:
        'Found the perfect nanny within a week. The verification process gave us total peace of mind.',
      rating: 5,
    },
    {
      name: 'David Kim',
      ...
      quote:
        'The flexibility to book care on short notice has been a game-changer for our family.',
      rating: 5,
    },
    {
    ...
    },
    {
      ...
      quote:
        'The caregivers are professional, caring, and my kids absolutely love them.',
      rating: 5,
    },
  ];
