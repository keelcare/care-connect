...
export const TrustedBy: React.FC = () => {
    ...
    const marqueeUsers = [...users, ...users, ...users];
            ...
            <div className="relative w-full">
                ...
                <div className="flex gap-12 animate-scroll-left w-max">
                    {marqueeUsers.map((user, index) => (
                        <div key={index} className="flex items-center gap-4 bg-white px-6 py-3 rounded-full shadow-sm border border-neutral-100">
