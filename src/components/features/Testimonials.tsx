...
export const Testimonials: React.FC = () => {
  const testimonials = [
    ...
    {
      quote:
        "I needed someone to look after my dad while I'm at work. The caregivers here are so professional and kind. It's been a lifesaver.",
      authorName: 'David K.',
    ...
    {
      quote:
        'As a pet sitter, I love how easy it is to find clients and manage my schedule. The platform is super user-friendly.',
