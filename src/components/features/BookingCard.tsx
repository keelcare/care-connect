            ...
            <div className={styles.actions}>
                ...
                {loading ? (
                    ...
                    <div className={styles.buttons}>
                        {booking.status === 'CONFIRMED' && userRole === 'nanny' && onStart && (
                            <Button variant="default" size="sm" onClick={() => onStart(booking.id)}>
                                Start
                            </Button>
                        )}

                        {booking.status === 'IN_PROGRESS' && onComplete && (
                            <Button variant="default" size="sm" onClick={() => onComplete(booking.id)}>
                                Complete
                            </Button>
                        )}

                        {(booking.status === 'CONFIRMED' || booking.status === 'IN_PROGRESS') && onCancel && (
