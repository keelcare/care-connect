                    ...
                    <div className="flex flex-col items-center justify-center h-full text-stone-400 p-8">
                        ...
                        {searchQuery ? (
                            ...
                            <>
                                ...
                                <p className="text-xs mt-1 text-center">Start a booking to begin chatting!</p>
                            </>
                        )}
                    </div>
                ) : (
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <p className={`text-sm truncate ${
                                            chat.unreadCount ? 'text-stone-700 font-medium' : 'text-stone-500'
                                        }`}>
                                            {chat.lastMessage || chat.booking?.job?.title || 'Booking conversation'}
                                        </p>
