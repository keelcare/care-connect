  ...
  const services = [
    {
      title: 'Child Care',
      description:
        'Experienced nannies and babysitters for children of all ages',
      icon: Baby,
      count: '5,200+ caregivers',
      image:
        'https://images.unsplash.com/photo-1587654780291-39c9404d746b?q=80&w=400&auto=format&fit=crop',
    },
    {
      title: 'Senior Care',
