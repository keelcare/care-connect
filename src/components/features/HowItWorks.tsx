    ...
    const steps = [
        {
            ...
            icon: Search,
            title: "Search",
            description: "Browse through our network of verified caregivers. Filter by location, availability, and specialty."
        },
        {
            step: "02",
            icon: UserCheck,
            title: "Review & Select",
            description: "Read reviews, check credentials, and view detailed profiles to find your perfect match."
        },
        {
            step: "03",
            icon: MessageCircle,
            title: "Connect",
            description: "Message caregivers directly, ask questions, and discuss your specific needs."
        },
        {
            step: "04",
            icon: CalendarCheck,
            title: "Book & Relax",
            description: "Schedule care sessions with confidence. Manage everything from your dashboard."
        },
    ];
        ...
        <section className="py-24 px-6 bg-stone-900 text-white">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <p className="text-sm font-semibold text-stone-400 uppercase tracking-widest mb-3">How It Works</p>
