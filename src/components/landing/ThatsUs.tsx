      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center" style={{ background: "linear-gradient(160deg, hsl(38, 60%, 97%) 0%, hsl(30, 50%, 95%) 50%, hsl(45, 55%, 96%) 100%)" }}>
        ...
        >
          ...
          >
            ...
            >
              <Link href="/contact">
                <button className="w-full sm:w-auto bg-primary-900 text-white px-10 py-4 rounded-full font-semibold text-base md:text-lg hover:bg-primary-800 hover:scale-105 transition-all shadow-lg shadow-primary-900/20 cursor-pointer">
                  Get in touch
                </button>
              </Link>
            </motion.div>
