...
export default function BookRecurringPage() {
    ...
    useEffect(() => {
        const fetchNanny = async () => {
            ...
            try {
                const id = Array.isArray(params.nannyId) ? params.nannyId[0] : params.nannyId;
                const data = await api.users.get(id);
                setNanny(data);
            } catch (error) {
                console.error("Failed to fetch nanny:", error);
                addToast({ message: "Failed to load caregiver details", type: "error" });
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const recurrencePattern = generateRecurrencePattern(formData.frequency, formData.selectedDays);
            ...
            addToast({ message: error.message || 'Failed to create recurring booking', type: 'error' });
        } finally {
            setSubmitting(false);
        }
    };

    const canProceedToStep2 = formData.frequency === 'daily' || formData.selectedDays.length > 0;
    const canProceedToStep3 = formData.startDate !== '' && formData.startTime !== '' && formData.duration !== '';
        ...
        return (
            <ParentLayout>
                <div className="flex flex-col items-center justify-center min-h-screen bg-stone-50">
                    <h2 className="text-xl font-bold text-stone-900">Caregiver not found</h2>
                    <Button 
                ...
                <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h1 className="text-3xl font-bold text-stone-900">Create Recurring Booking</h1>
                        </div>
                        <p className="text-stone-500 mt-1">Schedule regular care sessions with your caregiver</p>
                    </div>
                            ...
                            {currentStep === 1 && (
                                <div className="p-6 md:p-8">
                                    <div className="flex items-center gap-2 mb-6">
                                        ...
                                        <h2 className="text-xl font-bold text-stone-900">How often do you need care?</h2>
                                    </div>
                                    
                                    {/* Frequency Selection */}
                                    <div className="mb-6">
                                        <label className="block text-sm font-medium text-stone-700 mb-3">Frequency</label>
                                            ...
                                            {['daily', 'weekly', 'monthly'].map((freq) => {
                                                ...
                                                return (
                                                    <button
                                                        key={freq}
                                                        type="button"
                                                        onClick={() => setFormData({ ...formData, frequency: freq, selectedDays: [] })}
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-7 gap-2">
                                                {Array.from({ length: 28 }, (_, i) => i + 1).map((date) => {
                                                    ...
                                                    const isSelected = formData.selectedDays.includes(dateStr);
                                                    return (
                                                        <button
                                                            key={date}
                                                            type="button"
                                                            onClick={() => {
                                                                const newDays = isSelected
                                                                    ? formData.selectedDays.filter(d => d !== dateStr)
                                                                    : [...formData.selectedDays, dateStr].sort((a, b) => parseInt(a) - parseInt(b));
                                    ...
                                    {formData.frequency === 'daily' && (
                                        <div className="p-4 bg-purple-50 rounded-xl border border-purple-100">
                                            <p className="text-sm text-purple-700">
                                                <strong>Daily:</strong> Bookings will be created for every day between your start and end dates.
                                            </p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="p-6 md:p-8">
                                    ...
                                    <div className="mb-8">
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <h2 className="text-xl font-bold text-stone-900">Date Range</h2>
                                        </div>
                                    ...
                                    <div className="mb-8">
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <h2 className="text-xl font-bold text-stone-900">Start Time</h2>
                                        </div>
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <h2 className="text-xl font-bold text-stone-900">Duration</h2>
                                        </div>
                            ...
                            {currentStep === 3 && (
                                <div className="p-6 md:p-8">
                                    <div className="flex items-center gap-2 mb-6">
                                        ...
                                        <h2 className="text-xl font-bold text-stone-900">Additional Details</h2>
                                    </div>
                                    ...
                                    <div className="mt-8 p-5 bg-purple-50 rounded-2xl border border-purple-200">
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium text-stone-900">{getNannyName()}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium text-stone-900">
                                                    {formData.frequency === 'daily' 
                                                        ? 'Daily' 
                                                        : formatRecurrencePattern(generateRecurrencePattern(formData.frequency, formData.selectedDays))
                                                    }
                                                </span>
                                            </div>
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium text-stone-900">
                                                    {formData.startDate 
                                                        ? new Date(formData.startDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' }) 
                                                        : '-'
                                                    }
                                                </span>
                                            </div>
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium text-stone-900">{formData.startTime || '-'}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-stone-500">Duration</span>
                                                <span className="font-medium text-stone-900">
                                                    {formData.duration ? `${formData.duration} hour${parseInt(formData.duration) > 1 ? 's' : ''}` : '-'}
                                                </span>
                                            </div>
                                            {nanny.nanny_details?.hourly_rate && formData.duration && (
                                                <div className="flex justify-between pt-3 border-t border-purple-200">
                                                    <span className="text-stone-500">Est. per session</span>
                                                    <span className="font-bold text-purple-700">
                                                        ₹{(parseFloat(nanny.nanny_details.hourly_rate) * parseInt(formData.duration)).toFixed(0)}
                                                    </span>
                                                </div>
                                            )}
                                        </div>
