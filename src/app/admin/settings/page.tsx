...
import { Settings, Save, RefreshCw, MapPin, Clock, DollarSign, Shield, Bell } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-stone-900 font-display">System Settings</h1>
                                    ...
                                    <div key={config.key} className="p-6">
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <h3 className="font-medium text-stone-900">{config.label}</h3>
                                                ...
                                                {config.type === 'boolean' ? (
                                                    <button
                                                        ...
                                                        className={cn(
                                                            ...
                                                            settings[config.key] ? "bg-emerald-600" : "bg-stone-300"
                                                        )}
                                                    >
                                                        <div className={cn(
                                                    ...
                                                    <>
                                                        <input
                                                            ...
                                                            onChange={(e) => handleChange(config.key, 
