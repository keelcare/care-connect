...
import { Star, CheckCircle, XCircle, Clock, AlertTriangle, Filter } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-stone-900 font-display">Review Moderation</h1>
                            <p className="text-stone-500">Approve or reject user reviews</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    {reviews.length === 0 ? (
                        <div className="bg-white rounded-2xl border border-stone-200 p-12 text-center">
                            ...
                            <h3 className="text-lg font-semibold text-stone-900 mb-2">All caught up!</h3>
                            <p className="text-stone-500">No reviews pending moderation.</p>
                        </div>
                    ) : (
                        reviews.map((review) => (
                            <div
                            ...
                            >
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1">
                                        ...
                                        {/* Rating Categories */}
                                        {(review.rating_punctuality || review.rating_professionalism || 
                                          review.rating_care_quality || review.rating_communication) && (
                                        ...
                                        <p className="text-stone-600 mb-4">
                                            {review.comment || <span className="italic text-stone-400">No comment provided</span>}
                                        </p>

                                        <div className="flex items-center gap-4 text-sm text-stone-500">
                                            <span>
                                                By: {review.reviewer?.profiles?.first_name || 'Anonymous'} {review.reviewer?.profiles?.last_name || ''}
                                            </span>
                                            <span>•</span>
                                            <span>
                                                For: {review.reviewee?.profiles?.first_name || 'User'} {review.reviewee?.profiles?.last_name || ''}
                                            </span>
                                        </div>
                                    </div>
