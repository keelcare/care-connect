    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-3xl font-bold text-neutral-900 font-display">Send Notifications</h1>
            </div>
            ...
            <div className="bg-white rounded-[32px] border border-neutral-100 shadow-soft p-8">
                <div className="flex items-center gap-4 mb-8 pb-6 border-b border-neutral-100">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-neutral-900">Manual Notification</h2>
                        <p className="text-neutral-500">Send alerts to users for testing or announcements</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-neutral-700">Notification Type</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-neutral-700">Recipient (User ID or Email)</label>
                            <input
                                type="text"
                                name="to"
                                value={formData.to}
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-neutral-700">Content</label>
                        <textarea
                            name="content"
