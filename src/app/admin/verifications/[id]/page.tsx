            ...
            <div className="bg-white shadow-soft rounded-[24px] overflow-hidden border border-neutral-100 mb-8">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <span className="text-gray-900">{user.profiles?.full_name || `${user.profiles?.first_name} ${user.profiles?.last_name}`}</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span className="text-gray-900">{user.profiles?.phone || 'N/A'}</span>
                    </div>
                    <div>
                        <span className="block text-sm font-medium text-gray-500">Address</span>
                        <span className="text-gray-900">{user.profiles?.address || 'N/A'}</span>
                    </div>
                </div>
            </div>
                                    ...
                                    <div key={index} className="border border-gray-200 rounded-lg p-2">
                                        ...
                                        <div className="space-y-1 px-1">
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <p className="text-sm font-medium text-gray-900 truncate max-w-[150px]" title={doc.original_name || doc.file_path.split('/').pop()}>
            ...
            {showRejectModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg max-w-md w-full p-6 shadow-xl">
                        ...
                        <p className="text-gray-600 mb-4">Please specify the reason for rejection. This will be shown to the user.</p>
