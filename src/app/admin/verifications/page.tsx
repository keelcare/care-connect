...
export default function AdminPendingVerificationsPage() {
    ...
    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Pending Identity Verifications</h1>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                <div className="text-sm font-medium text-gray-900">
                                                    {user.profiles?.full_name || `${user.profiles?.first_name || ''} ${user.profiles?.last_name || ''}`}
                                                </div>
