...
export default function RequestDetailsPage() {
    ...
    const handleConfirm = async () => {
        if (!request || !request.nanny_id) return;

        try {
            setConfirming(true);
            // Assuming there's an endpoint to accept/confirm the assignment
            // If not, we might need to create a booking from this request
            // For now, let's assume we create a booking
            ...
            const bookingPayload = {
                ...
                jobId: request.id // Linking back to request
            };
    ...
    const getStatusInfo = (status: string) => {
        switch (status) {
            ...
            case 'ASSIGNED': return { color: 'text-emerald-700 bg-emerald-100', icon: <CheckCircle size={20} />, text: 'Nanny Assigned' };
        ...
        <ParentLayout>
            <div className="max-w-7xl mx-auto p-6 md:p-10 lg:p-12 space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-neutral-900 font-display">Request Details</h1>
                        <p className="text-neutral-500 mt-1 font-mono text-sm">ID: {request.id}</p>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-neutral-900 font-medium">{new Date(request.date).toLocaleDateString()}</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                        ...
                        {assignedNanny && (
                            <div className="space-y-4">
                                ...
                                <ProfileCard
                                    ...
                                    hourlyRate={Number(assignedNanny.nanny_details?.hourly_rate) || 0}
                            ...
                            <div className="space-y-3">
                                ...
                                {request.status === 'CANCELLED' && (
                                    <div className="p-4 bg-red-50 rounded-xl text-center">
                                        <p className="text-red-700 font-medium">This request has been cancelled.</p>
                                    </div>
                                )}
