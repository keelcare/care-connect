...
function MessagesContent() {
    ...
    return (
        <div className="h-[calc(100vh-120px)] bg-white rounded-[32px] border border-neutral-100 shadow-soft overflow-hidden flex">
            ...
            <div className={`w-full lg:w-80 lg:flex-shrink-0 ${showChatOnMobile ? 'hidden lg:block' : 'block'}`}>
                <ChatSidebar
                    chats={chats}
            ...
            {/* Chat Window */}
            <div className={`flex-1 ${!showChatOnMobile && !activeChat ? 'hidden lg:flex' : 'flex'} flex-col`}>
                {activeChat ? (
                    <EnhancedChatWindow
                        chat={activeChat}
                    ...
                    <div className="flex-1 flex items-center justify-center text-neutral-400 bg-stone-50/50">
                        <div className="text-center">
                            ...
                            <p className="text-stone-500">Select a conversation to start messaging</p>
                        </div>
                    </div>
                )}
            </div>
