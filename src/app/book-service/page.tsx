...
export default function BookServicePage() {
    ...
    const canProceedToStep3 = formData.date !== '' && formData.startTime !== '' && formData.duration !== '';
            ...
            <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-stone-50 pb-20">
                <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-stone-500 mt-1">Tell us what you need and we'll find the perfect caregiver for you</p>
                    </div>
                                ...
                                <div className="p-6 md:p-8">
                                    ...
                                    <div className="mb-8">
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <h2 className="text-xl font-bold text-stone-900">Select a Date</h2>
                                        </div>
                                            ...
                                            {availableDates.map((date) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <span className={`text-2xl font-bold ${isToday(date) && !isSelected ? 'text-emerald-600' : ''}`}>
                                                            {date.getDate()}
                                                        </span>
                                    ...
                                    <div className="mb-8">
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <h2 className="text-xl font-bold text-stone-900">Select Start Time</h2>
                                        </div>
                                    ...
                                    <div className="mt-8 p-5 bg-stone-50 rounded-2xl border border-stone-200">
                                        ...
                                        <div className="space-y-3 text-sm">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium text-stone-900">{formData.duration ? `${formData.duration} hours` : '-'}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-stone-500">People</span>
                                                <span className="font-medium text-stone-900">{formData.numChildren}</span>
                                            </div>
                                        </div>
