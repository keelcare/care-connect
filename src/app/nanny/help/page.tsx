...
export default function NannyHelpPage() {
    ...
    const handleContestBan = async () => {
        if (!contestMessage.trim()) {
            alert('Please enter a message explaining why you think this ban is incorrect.');
            return;
        }

        // TODO: Send to backend API
        alert('Your appeal has been submitted. Our team will review it within 24-48 hours.');
                            ...
                            <div className="flex-1 space-y-3">
                                <div>
                                    ...
                                    <p className="text-red-700 text-sm">
                                        Your account has been temporarily suspended due to: <strong>{user.ban_reason || 'Terms of Service violation'}</strong>
                                    </p>
                                </div>
                    ...
                    <div className="divide-y divide-stone-100">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-semibold text-stone-900">Contact Support</div>
                                    <div className="text-sm text-stone-500">Get help from our team via email</div>
                                </div>
                            </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-semibold text-stone-900">Community Guidelines</div>
                                    <div className="text-sm text-stone-500">Review platform policies and rules</div>
                                </div>
                            </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-semibold text-stone-900">FAQ & Help Center</div>
                                    <div className="text-sm text-stone-500">Find answers to common questions</div>
                                </div>
                            </div>
                            <ChevronRight size={18} className="text-stone-300 group-hover:text-purple-500" />
                        </a>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-semibold text-stone-900">Live Chat Support</div>
                                    <div className="text-sm text-stone-500">Chat with our support team in real-time</div>
                                </div>
                            </div>
                    ...
                    <div className="space-y-4">
                        <details className="group">
                            ...
                            <p className="mt-2 text-sm text-stone-600 pl-4">
                                Go to Dashboard → Profile → Edit Profile. You can update your bio, skills, hourly rate, and availability.
                            </p>
                        </details>
                        <details className="group">
                            <summary className="cursor-pointer font-medium text-stone-900 hover:text-emerald-600 transition-colors">
                            ...
                            <p className="mt-2 text-sm text-stone-600 pl-4">
                                Navigate to Verification page and upload your identity documents (Aadhar/PAN/Voter ID). Admin will review within 24-48 hours.
                            </p>
                        </details>
                        <details className="group">
                            <summary className="cursor-pointer font-medium text-stone-900 hover:text-emerald-600 transition-colors">
