        ...
        {user.identity_verification_status === 'verified' ? (
          <div className="bg-white p-8 rounded-[24px] shadow-soft border border-emerald-100 text-center space-y-6">
            ...
            <p className="text-lg text-gray-600">
              Your profile has been successfully verified. You are now eligible
          ...
          <div className="space-y-8">
            <VerificationStatus status="pending" rejectionReason={null} />

            <div className="text-center pt-4 border-t border-gray-100">
              <p className="text-sm text-gray-500 mb-4">
                Made a mistake? You can withdraw this application and submit a
                new one.
              </p>
              <button
                onClick={async () => {
                  if (
                    confirm(
                      'Are you sure? This will delete your current submission.'
                    )
                  ) {
                    setLoading(true);
                    try {
