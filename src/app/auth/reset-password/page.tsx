                ...
                <div className="w-full max-w-[1920px] h-full flex bg-white shadow-2xl mx-auto overflow-hidden">
                    <div className="w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 xl:px-32 py-12">
                        <div className="w-full max-w-md mx-auto my-auto text-center">
                            ...
                            <h1 className="text-3xl font-bold text-neutral-900 mb-3 font-display">Invalid Reset Link</h1>
                ...
                <div className="w-full max-w-[1920px] h-full flex bg-white shadow-2xl mx-auto overflow-hidden">
                    <div className="w-full lg:w-1/2 h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 xl:px-32 py-12 overflow-y-auto">
                        <div className="w-full max-w-md mx-auto my-auto text-center">
                            ...
                            <h1 className="text-3xl font-bold text-neutral-900 mb-3 font-display">Password Reset!</h1>
                            <p className="text-neutral-500 mb-8">
                    ...
                    <div className="hidden lg:flex w-1/2 h-full bg-gradient-to-br from-emerald-50 to-stone-100 relative overflow-hidden items-center justify-center">
                        <div className="text-center p-12">
                            ...
                            <h2 className="text-2xl font-bold text-stone-800 mb-4">Success!</h2>
            ...
            <div className="w-full max-w-[1920px] h-full flex bg-white shadow-2xl mx-auto overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 xl:px-32 py-12 overflow-y-auto">
                    <div className="w-full max-w-md mx-auto my-auto">
                        ...
                        <div className="mb-10">
                            ...
                            <h1 className="text-3xl font-bold text-neutral-900 mb-3 font-display">Set new password</h1>
                ...
                <div className="hidden lg:flex w-1/2 h-full bg-gradient-to-br from-stone-100 to-emerald-50 relative overflow-hidden items-center justify-center">
                    <div className="text-center p-12">
                        ...
                        <h2 className="text-2xl font-bold text-stone-800 mb-4">Secure Password</h2>
                        <p className="text-stone-600 max-w-xs mx-auto">
