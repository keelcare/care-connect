...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await login(response.access_token, response.user, response.refresh_token);
        } catch (error) {
        ...
        <div className="h-screen w-full flex bg-neutral-50 justify-center overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 xl:px-32 py-12 overflow-y-auto">
                <div className="w-full max-w-md mx-auto my-auto">
                    ...
                    <div className="mb-10">
                        ...
                        <h1 className="text-3xl font-bold text-neutral-900 mb-3 font-display">Welcome back</h1>
                    ...
                    <button
                        ...
                        type="button"
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-neutral-200 rounded-xl bg-white hover:bg-neutral-50 transition-colors text-neutral-700 font-medium h-12"
                    >
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-neutral-500 text-sm">Don&apos;t have an account?{' '}
                            <Link href="/auth/signup" className="font-medium text-neutral-900 hover:underline transition-all">
                                Sign up
                            </Link>
                        </p>
                    </div>
            ...
            <div className="hidden lg:flex w-1/2 h-full bg-[#F0FDF4] relative overflow-hidden items-center justify-center">
                <style jsx>{`
                    ...
                    .flower-container { transform-origin: bottom center; animation: sway 8s ease-in-out infinite; }
                    .flower-head { transform-origin: 200px 250px; animation: bloom 5s ease-in-out infinite; }
                    .glow { animation: pulse-soft 4s ease-in-out infinite; }
                `}</style>
                ...
                <div className="relative w-[500px] h-[500px] flex items-center justify-center">
                    ...
                    {/* Flower Animation */}
                    <div className="relative w-full h-full flex items-end justify-center pb-10 flower-container">
                        <svg width="400" height="500" viewBox="0 0 400 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g className="flower-head">
                                {/* Petals */}
                                <circle cx="200" cy="190" r="35" fill="#FDBA74" className="opacity-90" />
                                <circle cx="200" cy="310" r="35" fill="#FDBA74" className="opacity-90" />
                                <circle cx="148" cy="220" r="35" fill="#FDBA74" className="opacity-90" />
                                <circle cx="252" cy="220" r="35" fill="#FDBA74" className="opacity-90" />
                                <circle cx="148" cy="280" r="35" fill="#FDBA74" className="opacity-90" />
                                <circle cx="252" cy="280" r="35" fill="#FDBA74" className="opacity-90" />
