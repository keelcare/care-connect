  ...
  const values = [
    {
      ...
      title: 'Safety First',
      description:
        "Every caregiver undergoes thorough background checks and identity verification. Your family's safety is non-negotiable.",
    },
    {
      icon: Heart,
      title: 'Compassionate Care',
      description:
        'We connect you with caregivers who genuinely care, bringing warmth and dedication to every interaction.',
    },
    {
      icon: Users,
      title: 'Community Driven',
      description:
        'Building meaningful relationships between families and caregivers that go beyond just services.',
    },
    {
      icon: Award,
      title: 'Excellence',
      description:
        'Committed to the highest standards in everything we do, continuously improving based on your feedback.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-stone-600 leading-relaxed">
                Today, we've built a platform that combines rigorous
                verification with an intuitive experience, making it easier than
                ever to find the perfect caregiver match.
              </p>
          ...
          <div className="prose prose-lg prose-stone max-w-none">
            <div className="bg-stone-50 rounded-2xl p-8 md:p-10 border border-stone-100">
              <p className="text-stone-600 leading-relaxed mb-6">
                In 2020, our founders—working parents themselves—found
                themselves struggling to find reliable childcare. The process
                was fragmented, stressful, and often felt like a leap of faith.
              </p>
              <p className="text-stone-600 leading-relaxed mb-6">
                They realized they weren't alone. Millions of families face the
                same challenge every day: finding someone they can trust to care
              ...
              <p className="text-stone-600 leading-relaxed">
                Today, we've helped over 50,000 families find the care they
                need. But we're just getting started. Our vision is a world
                where every family has access to safe, reliable, affordable
                care.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 px-6 bg-stone-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-stone-400 mb-8 max-w-2xl mx-auto">
            Whether you're a family looking for care or a caregiver ready to
