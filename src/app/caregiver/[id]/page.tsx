          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-white p-4 rounded-xl border border-stone-100 shadow-lg shadow-stone-200/50 flex flex-col items-center text-center">
              ...
              <div className="font-bold text-stone-900">
                {nanny_details?.experience_years || 0}y
              </div>
                ...
                <section>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {nanny_details?.skills?.map((skill, index) => (
                      <span
                        key={index}
                        className="px-4 py-2 bg-stone-100 border border-stone-200 rounded-xl text-stone-700 font-medium text-sm"
                      >
                        {skill}
                      </span>
                    )) || (
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                <div className="space-y-3">
                  {nanny_details?.availability_schedule ? (
                    Object.entries(nanny_details.availability_schedule).map(
                      ([day, slots]) => (
                        <div
                          key={day}
                          className="p-4 border border-stone-100 rounded-xl bg-white flex items-center justify-between shadow-sm"
                        >
                ...
                <>
                  <Button
                    ...
                    onClick={() => {
                      ...
                      document
                        .querySelector('button[onClick*="availability"]')
